                    ...
                    <table class="table table-bordered table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td><span class="badge bg-secondary"><?= htmlspecialchars($row['kategori'] ?? 'Alat'); ?></span></td> <!-- Tambahkan ini -->
                                <td><span class="badge <?= $badge_class; ?>"><?= htmlspecialchars($row['kondisi_alat']); ?></span></td>
                                <td><?= htmlspecialchars($row['merek_alat']); ?></td>
                                <td><?= htmlspecialchars($row['jumlah_alat']); ?></td>
                                ...
                                <td>
                                    ...
                                    <a href="proses_inventaris.php?hapus=<?= $row['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin hapus barang ini?')">
...
<div class="modal fade" id="modalTambahBarang" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <form action="proses_inventaris.php" method="POST" class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3"><label>Nama Alat/Bahan</label><input type="text" name="nama" class="form-control" required></div>
                <div class="mb-3">
                ...
                <div class="mb-3"><label>Merek</label><input type="text" name="merek" class="form-control" required></div>
                <div class="row">
                    <div class="col-md-6 mb-3"><label>Jumlah</label><input type="number" name="jumlah" class="form-control" required></div>
                    <div class="col-md-6 mb-3"><label>Ukuran</label><input type="text" name="ukuran" class="form-control" placeholder="misal: 100ml"></div>
                </div>
            </div>
...
<div class="modal fade" id="modalEditBarang" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <form action="proses_inventaris.php" method="POST" class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3"><label>Nama Alat/Bahan</label><input type="text" name="nama" id="edit_nama" class="form-control" required></div>
                <div class="mb-3">
                    <label>Kategori</label>
                ...
                <div class="mb-3"><label>Merek</label><input type="text" name="merek" id="edit_merek" class="form-control" required></div>
                <div class="row">
                    <div class="col-md-6 mb-3"><label>Jumlah</label><input type="number" name="jumlah" id="edit_jumlah" class="form-control" required></div>
                    <div class="col-md-6 mb-3"><label>Ukuran</label><input type="text" name="ukuran" id="edit_ukuran" class="form-control"></div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
...
<script>
    function editBarang(data) {
        ...
        document.getElementById('edit_kondisi').value = data.kondisi_alat;
